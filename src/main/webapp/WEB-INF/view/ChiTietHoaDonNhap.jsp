...
<form:form modelAttribute="hoadonnhap" class="form-horizontal col-sm-10 col-sm-offset-1">
        <div class="form-group">
                <label class="control-label col-sm-2"> Tên Nhà Xuất Bản:</label>
                <div class="col-sm-8">
                	<label  class="control-label" >${hoadonnhap.getTenNhaXuatBan()}<label>
                </div>
         </div>
         <div class="form-group">
                <label class="control-label col-sm-2">Ngày Nhập:</label>
                <div class="col-sm-8" >
                	<label class="control-label" style="text-align: left;">${hoadonnhap.getNgayNhap()}</label>
                </div>
          </div>
          ...
          <div class="form-group">
                ...
                <div class="col-sm-8" >
                	<label class="control-label" style="text-align: left;">${hoadonnhap.getTongTien()}</label>
                </div>
          </div>
          ...
          <div class="form-group">
                ...
                <div class="col-sm-8" >
		           ...
		           <table class="table table-bordered">
		            ...
		            <c:forEach var="sach" items="${hoadonnhap.getGetSachHDN()}">
		                <tr>
